...
\address{IOP Publishing, No. 2 The Distillery, Avon Street, Bristol BS2 0GR, UK}
\ead{customerservices@ioppublishing.org}
\vspace{10pt}
\begin{indented}
...
journals listed in table~\ref{jlab1} on the next page.  You are not obliged to use this class file---{\bf we accept
...
We also accept submissions in Word format.  See our Publishing Support site for guidelines on Word submissions.
