...
def doseMatMerge():
    ...
    expFolder = "/data/qifan/projects/FastDoseWorkplace/Pancreas/Patient004/FastDose"
    numMatrices = 2
...
def drawDoseWash():
    patientFolder = "/data/qifan/projects/FastDoseWorkplace/Pancreas/Patient004"
    expFolder = os.path.join(patientFolder, "FastDose")
    prep_output = os.path.join(expFolder, "prep_output")
    doseShape = (155, 240, 240)
