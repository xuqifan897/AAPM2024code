...
def copyOtherFiles():
    ...
    for i in range(numPatients):
        ...
        for file in sourceFiles:
            command = "cp {} {}".format(os.path.join(templateFolder, file),
                os.path.join(expPrepFolder, file))
            os.system(command)
...
def fluenceMapGen():
    ...
    for i in range(numPatients):
        ...
        for j in range(numChunks):
            fluenceMapFile = os.path.join(targetFolder, patientName,
        ...
        # write to file
        fluenceFolder = os.path.join(targetFolder, patientName,
