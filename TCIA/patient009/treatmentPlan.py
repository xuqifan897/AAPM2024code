...
def examineDose_new():
    ...
    patientFolder = "/data/qifan/projects/FastDoseWorkplace/TCIASelect/009"
...
def dcm2nii():
    ...
    targetFile = "/data/qifan/projects/FastDoseWorkplace/TCIASelect/009/HeadNeck.nii"
    nib.save(nifti_img, targetFile)
    print(nifti_img)


def examine_nifti():
    sourceFile = "/data/qifan/projects/FastDoseWorkplace/TCIASelect/009/HeadNeck.nii"
    image = nib.load(sourceFile).get_fdata()
    image = np.transpose(image, axes=(2, 1, 0))
    targetFolder = "/data/qifan/projects/FastDoseWorkplace/TCIASelect/009/niiView"
...
def preMaskCreation():
    ...
    exclude = ["CTV56", "CTV70", "GTV", "ltpar+.5", "ptv_70+.3", "rtpar+.5"]
...
def StructInfoGen():
    ...
    if True:
        ...
        expFolder = "/data/qifan/projects/FastDoseWorkplace/TCIASelect/009/FastDose"
