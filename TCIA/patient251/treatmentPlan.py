...
def examineDose_new():
    ...
    patientFolder = "/data/qifan/projects/FastDoseWorkplace/TCIASelect/251"
...
def preMaskCreation():
    ...
    exclude = ["CTV56", "CTV63", "CTV70", "GTV", "BRAIN_STEM"]
...
def StructInfoGen():
    ...
    if True:
        ...
        expFolder = "/data/qifan/projects/FastDoseWorkplace/TCIASelect/251/FastDose"
