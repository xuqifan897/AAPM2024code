...
def checkPrep():
    folder = "/data/qifan/projects/FastDoseWorkplace/CORTTune/Prostate/prep_output"
    shape = (108, 221, 221)
...
def doseAnalyze():
    prep_output = "/data/qifan/projects/FastDoseWorkplace/CORTTune/Prostate/prep_output"
    prep_result = "/data/qifan/projects/FastDoseWorkplace/CORTTune/Prostate/plan1"
    dimension = (108, 221, 221)
    VOI_exclude = ["RingStructure", "BODY"]
