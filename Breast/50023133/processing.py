...
patientName = "50023133"
targetResolution = np.array((2.5, 2.5, 2.5))  # mm

names_useful = ['A_LAD', 'Breast_R', 'Chestwall_L_experimental', 'Chestwall_R_experimental',
                'Esophagus', 'Heart', 'Humerus_L', 'Liver', 'Lung_L', 'Lung_R', 'Nipple',
                'SpinalCord', 'Sternum', 'Stomach', 'Trachea', 'Ventricle_L', 'Shoulder_L',
                'PTV_PBI_L', 'External', 'Breast_L-PTV']
