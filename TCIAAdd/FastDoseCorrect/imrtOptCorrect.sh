...
for patientName in 003; do
    ...
    outputFolder="${expFolder}/doseMat0 ${expFolder}/doseMat1 ${expFolder}/doseMat2 ${expFolder}/doseMat3"
    ...
    OMP_NUM_THREADS=64 ${exec} \
        ...
        --beamlist "${targetPatientFolder}/beamlist0.txt" \
        --mode 1 \
        --device 3 \
        --spectrum "${dataFolder}/spec_6mv.txt" \
